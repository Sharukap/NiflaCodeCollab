...
class CreateCrimeReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('crime_reports', function (Blueprint $table) {
            ...
            //connecting with the action taken
            $table->unsignedBigInteger('taken_action_id')->nullable();
            $table->foreign('taken_action_id')->references('id')->on('taken_action')->onDelete('cascade');
        });
    }
